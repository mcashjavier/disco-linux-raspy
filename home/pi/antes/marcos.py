...
def drawPressKeyMsg():
    pressKeySurf = BASICFONT.render('Press a key to jugar.', True, DARKGRAY)
...
def drawApple(coord):
    x = coord['x'] * CELLSIZE
    y = coord['y'] * CELLSIZE
    appleRect = pygame.Rect(x, y, CELLSIZE+1, CELLSIZE+1)
    pygame.draw.rect(DISPLAYSURF, RED, appleRect)


def drawGrid():
    for x in range(0, WINDOWWIDTH, CELLSIZE): # draw vertical lines
        pygame.draw.line(DISPLAYSURF, BLUE, (x, 0), (x, WINDOWHEIGHT))
