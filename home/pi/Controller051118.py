        ...
        if True:#while treintento<11 and len(data)<46: #reintenta si no recibe respuesta del tcpserver
            try:
                   # Create a TCP/IP socket
                    while len(data)<3 and reintento<= 10 and buscartarjeta==1:
                        try:
                            time.sleep(0.005)
                            print('previo a conectar')
                            creesock=0
...
##            Debitar()
            #tarjeta=''
        time.sleep(0.010)                    
        if len(tarjeta)==15 and  ctk==0 and YaEntre==0 and principal==1: #and principal==1: #and YaEntre==0:# and TerminoOperacion==1 and
            YaEntre=1
            #while principal==0:
            #    time.sleep(0.010)
...
time.sleep(1.0)
#primer color
ColorLed('34','111','111','111','111','111','111','111','111','111','111','111','111','111','111','111','111')
time.sleep(1.0)
...
while PN=='-':
    try:
      ...
      if Conecto==1:
              ...
              if cambiednsh==1 and UsuarioConectado==0 or primeravez==0 and UsuarioConectado==0:#Conecto==0:
                      primeravez=1
      ...
      if Conecto==1:
          ...
          if Idioma==0:
                  ...
                  if len(data)>30:    
                      ...
                      CRCID=CRCID.strip()
                      VPAY=str(traje[(43+sumar):(44+sumar)])
                      VPAY=VPAY.strip()
