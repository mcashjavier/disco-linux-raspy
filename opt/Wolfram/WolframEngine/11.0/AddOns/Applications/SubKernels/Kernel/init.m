...
kernelInit[kernels:{___?subQ}] := Module[{incoming, connected,time, wt, selected, work, to, tol=$timeouts},
	...
	CheckAbort[
		...
		If[ Length[incoming]>0, (* too bad *)
			Message[General::time, LaunchKernels, to];
			Quiet[LinkClose /@ incoming]; Quiet[LinkClose /@ connected];
		];
