...
`Information`$CreationID = If[SyntaxQ["74"], ToExpression["74"], 0]
`Information`$CreationDate = If[SyntaxQ["{2017, 01, 22, 20, 39, 08}"], ToExpression["{2017, 01, 22, 20, 39, 08}"], {0,0,0,0,0,0}]
