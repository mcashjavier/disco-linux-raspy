...
googleplusimport[json_String]:=With[{res=ImportString[json,"RawJSON"]},
	If[FreeQ[Normal@res,_["error",_]],
		res,
...
googlepluscookeddata[prop_,id_,rules___Rule]:=googlepluscookeddata[prop,id,{rules}]  
