...
Begin["OpenLibrary`"] (* Begin Private Context *) 
...
openlibrarycookeddata[prop_,id_,rules___Rule]:=openlibrarycookeddata[prop,id,{rules}]
...
formatBookInformation[record_,showT_] := Module[{data,details,language,bibkey,covers,thumbnail,detailsData},
(
	...
	data = ReplaceAll[data,Rule["authors",x_]:>Rule["authors",{"name"/.#,"url"/.#}&/@x]];
