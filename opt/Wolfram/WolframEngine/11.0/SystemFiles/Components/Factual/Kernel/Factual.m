Get["FactualFunctions`"]

Begin["FactualAPI`"] (* Begin Private Context *)
...
(* Cooked *)
factualcookeddata[prop_,id_, rest___] := factualcookeddata[prop,id,{rest}]

(*factualcookeddata[req_, id_] :=
    factualcookeddata[req, id,{}]*)
