...
ChannelBrokerConnect::uerr = ChannelObject::uerr = RemoveChannelListener::uerr = "Unable to perform operation because of an error: `3` (status code `2`).";
ChannelListen::access = "Access denied to `1`.";
ChannelListen::authfail = SendMail::authfail;
...
ChannelSubscribers::farg = "The first argument `1` must be a string, a valid channel object, or a list containing strings or channel objects.";
...
CreateChannel::anon = DeleteChannel::anon = ChannelObject::anon = ChannelSend::anon = ChannelListen::anon = RemoveChannelListener::anon = ChannelBrokerConnect::anon = "Access to `1` denied for anonymous user (status code 403).";
...
CreateChannel::cbcon = DeleteChannel::cbcon = ChannelObject::cbcon = FindChannels::cbcon = ChannelSend::cbcon = ChannelListen::cbcon = RemoveChannelListener::cbcon = ChannelBrokerConnect::cbcon = ChannelBrokerDisconnect::cbcon = "Unable to connect to `1`.";
...
CreateChannel::uauth = "Access to `1` denied for `2` (status code 403).";
DeleteChannel::uauth = ChannelObject::uauth = ChannelSend::uauth = ChannelListen::uauth = ChannelSubscribers::uauth = ChannelBrokerConnect::uauth = "Access to `1` denied for `2` (status code 403). The channel may not exist.";
