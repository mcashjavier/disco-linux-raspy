Begin["PubChemAPI`"] (* Begin Private Context *) 
...
pubchemdata["RawCompounds"] := {
        "URL"				-> (ToString@StringForm["http://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/`1`/`2`/`3`/`4`/", #1,#2,#3,#4]&),
        "HTTPSMethod"		-> "GET",
...
pubchemdata["RawCompoundsPost"] := {
        "URL"				-> (ToString@StringForm["http://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/`1`/`2`/`3`/", #1,#2,#3]&),
        "HTTPSMethod"		-> "POST",
...
pubchemdata["RawSubstances"] := {
        "URL"				-> (ToString@StringForm["http://pubchem.ncbi.nlm.nih.gov/rest/pug/substance/`1`/`2`/`3`/`4`/", #1,#2,#3,#4]&),
        "HTTPSMethod"		-> "GET",
        "PathParameters"	-> {"namespace","identifiers","operation","format"},
...
pubchemdata["RawCompoundImage"] := {
        "URL"				-> (ToString@StringForm["http://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/`1`/`2`/PNG/", #1,#2]&),
        "HTTPSMethod"		-> "GET",
...
pubchemdata["RawCompoundImagePost"] := {
        "URL"				-> (ToString@StringForm["http://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/`1`/PNG/", #1]&),
        "HTTPSMethod"		-> "POST",
        "BodyData"			-> {"ParameterlessBodyData"->"identifiers"},
...
pubchemdata["RawSubstanceImage"] := {
        "URL"				-> (ToString@StringForm["http://pubchem.ncbi.nlm.nih.gov/rest/pug/substance/`1`/`2`/PNG/", #1,#2]&),
        "HTTPSMethod"		-> "GET",
        "PathParameters"	-> {"namespace","identifiers"},
        "Parameters"		-> {"record_type","image_size"},
        "RequiredParameters"-> {"namespace","identifiers"},
...
pubchemdata["RawCompoundSDF"] := {
        "URL"				-> (ToString@StringForm["http://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/`1`/`2`/SDF/", #1,#2]&),
        "HTTPSMethod"		-> "GET",
        "PathParameters"	-> {"namespace","identifiers"},
...
pubchemdata["RawCompoundSDFPost"] := {
        "URL"				-> (ToString@StringForm["http://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/`1`/SDF/", #1]&),
        "HTTPSMethod"		-> "POST",
        "BodyData"			-> {"ParameterlessBodyData"->"identifiers"},
        "PathParameters"	-> {"namespace"},
        "Parameters"		-> {"record_type"},
...
pubchemdata["RawSubstanceSDF"] := {
        "URL"				-> (ToString@StringForm["http://pubchem.ncbi.nlm.nih.gov/rest/pug/substance/`1`/`2`/SDF/", #1,#2]&),
        "HTTPSMethod"		-> "GET",
        "PathParameters"	-> {"namespace","identifiers"},
        "Parameters"		-> {"record_type"},
        "RequiredParameters"-> {"namespace","identifiers"},
...
pubchemcookeddata[req_, id_]:=pubchemcookeddata[req, id,{}]

pubchemcookeddata[prop_,id_,rules___Rule]:=pubchemcookeddata[prop,id,{rules}]
