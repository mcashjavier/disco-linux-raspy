Begin["SeatGeek`"] (* Begin Private Context *)
...
(*seatgeekcookeddata[req_, id_]:=seatgeekcookeddata[req, id, {}]*)
seatgeekcookeddata[prop_,id_,rules___Rule]:=seatgeekcookeddata[prop,id,{rules}]
