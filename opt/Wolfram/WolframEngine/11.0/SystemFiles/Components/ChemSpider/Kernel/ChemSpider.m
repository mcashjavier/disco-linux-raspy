...
Begin["ChemSpiderAPI`"] (* Begin Private Context *) 
...
(* Cooked *)
chemspidercookeddata[req_, id_]:=chemspidercookeddata[req, id,{}]

chemspidercookeddata[prop_,id_,rules___Rule]:=chemspidercookeddata[prop,id,{rules}]
