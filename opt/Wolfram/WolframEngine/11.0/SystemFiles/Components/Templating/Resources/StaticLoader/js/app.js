...
$(document).ready(function() {
  $("input[type=text],input[type=search],input[type=number]").filter(":not([data-codelanguage])").smartcontrol();
});
...
$(document).ready(function() {
	...
	$(":input:visible:not(:file),[tabindex]").not("[type=hidden]").not("[type=submit]").each(function(index) {
	    var self = $(this);
...
$(document).ready(function() {
    ...
    $('form').on("submit", function(e) {
        ...
        if ($(this).find("input[type=file]").length > 0) {
            ...
            if (input.length == 0) {
                input = $('<input type="hidden" name="_charset_"/>');
                form.append(input);
            }
