...
Iconize::deployment = "Deployment type `1` is not one of \"Default\", \"API\", \"WebForm\", \"EmbedCode\", \"Report\", \"Mobile\", \"Publish\", \"EditPage\", \"EmbedContent\", \"WebComputation\", \"ExportDoc\", or \"ScheduledProg\".";
Iconize::usage = "Iconize generates thumbnail icons of WL expressions";

SetAttributes[Iconize, HoldFirst];

Options[Iconize] = {ImageSize->Small, Platform->"FileBrowser"};
Iconize[expr_, dpl_: "Default", OptionsPattern[]] := Module[
