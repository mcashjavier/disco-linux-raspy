...
(* :Copyright: Mathematica source code (c) 1999-2017, Wolfram Research, Inc. All rights reserved. *)
...
`Information`$CreationID = If[SyntaxQ["20170122200009"], ToExpression["20170122200009"], 0]
`Information`$CreationDate = If[SyntaxQ["{2017,01,22,20,00,09}"], ToExpression["{2017,01,22,20,00,09}"], {0,0,0,0,0,0}]
