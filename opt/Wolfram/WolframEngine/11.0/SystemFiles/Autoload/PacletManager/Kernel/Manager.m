    ...
    Module[{paclets, pacletRootPath, javaLocations},
        If[paclet === Null,
            ...
            paclets = takeLatestEnabledVersionOfEachPaclet[
                          PCfindMatching["Extension" -> "JLink", "Collections" -> {"User", "Layout", "Legacy", "Extra", "CloudExtra"}]
                      ];
            If[paclets === {},
                Return[{}]
            ],
...
(* Merges values from the Extra paclets into $basePathMap, and assigns to $pathMap. *)
