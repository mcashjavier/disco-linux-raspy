...
*)
createPacletsFromParentDirs[parentDir_String, depth_Integer] := createPacletsFromParentDirs[{parentDir}, depth]

createPacletsFromParentDirs[parentDirs:{___String}, depth_Integer] :=
