...
SQLExecute[
    ...
    {sql = ps, params, useOpts, maxrows, 
        ...
        args = Replace[argsArg, None -> {}], useLongs, rdbms = getRDBMS[connection]},
    ...
    Block[{$JavaExceptionHandler = ThrowException},
        Catch[
             ...
             *)
            useLongs = Replace[Lookup[useOpts, "UseLongs"], {
              _ -> False /; StringMatchQ[rdbms, Alternatives @@ {"Microsoft Access*", "Microsoft Excel*"}]
            }];
