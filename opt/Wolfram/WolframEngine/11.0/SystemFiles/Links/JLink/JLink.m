...
(* :Copyright: J/Link source code (c) 1999-2017, Wolfram Research, Inc. All rights reserved.
...
*)
If[StringMatchQ["11.0", DigitCharacter ~~ ___] && ToExpression["11.0"] == $VersionNumber && !ValueQ[`Private`foundMX],
    Quiet[
        Check[
            `Private`foundMX =
...
JLink`Information`$BuildNumber = If[SyntaxQ["72"], ToExpression["72"], 0]
JLink`Information`$CreationID = If[SyntaxQ["20170122201101"], ToExpression["20170122201101"], 0]
JLink`Information`$CreationDate = If[SyntaxQ["{2017,01,22,20,11,01}"], ToExpression["{2017,01,22,20,11,01}"], {0,0,0,0,0,0}]
