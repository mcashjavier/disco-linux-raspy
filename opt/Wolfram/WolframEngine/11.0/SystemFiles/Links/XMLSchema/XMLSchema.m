...
XMLSchema`Information`$CreationID = If[SyntaxQ["74"], ToExpression["74"], 0]
XMLSchema`Information`$CreationDate = If[SyntaxQ["{2017, 01, 22, 21, 03, 41}"], ToExpression["{2017, 01, 22, 21, 03, 41}"], {0,0,0,0,0,0}]
