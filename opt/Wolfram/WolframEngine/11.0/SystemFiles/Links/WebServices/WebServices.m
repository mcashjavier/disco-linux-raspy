...
WebServices`Information`$CreationID = If[SyntaxQ["74"], ToExpression["74"], 0]
WebServices`Information`$CreationDate = If[SyntaxQ["{2017, 01, 22, 20, 47, 15}"], ToExpression["{2017, 01, 22, 20, 47, 15}"], {0,0,0,0,0,0}]
