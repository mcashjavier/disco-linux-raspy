...
resourceAccess0[fun_,id_,info_, rest___]:=With[{rtype=Lookup[info,"ResourceType",Throw[$Failed]]},
...
System`ResourceObject /: GenerateHTTPResponse[ro_System`ResourceObject] := GenerateHTTPResponse[HTTPResponse[createResourceShingle[ro]]]

System`ResourceObject /: CloudDeploy[ro_System`ResourceObject, rest___] := cloudDeployResource[ro, rest]
