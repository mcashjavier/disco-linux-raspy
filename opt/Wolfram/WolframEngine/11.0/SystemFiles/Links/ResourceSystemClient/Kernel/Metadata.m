...
requiredparameters[expr_,___]:=(Message[ResourceSubmit::invrt,expr];Throw[$Failed])

resourceInfoOrder[_]:={
	"Name","UUID",
	"RepositoryLocation","ResourceLocations",
	"ResourceType","ContentSize",
	"Version","Description",
	"Categories","ContentTypes","Keywords",
...
sortBasicInfo[as_]:=KeySortBy[as, basicInfoOrderFunc[Lookup[as,"ResourceType"]]]
...
$ResourceMetadataSchema:=Association[
	...
	"ContentTypes"->resourceContentTypes[All],
	...
	"ExternalLinks"->RepeatingElement[Restricted["Expression", {System`Hyperlink}] | "URL"]
]
...
$sourceLinkTypes={Restricted["String","*",$ShortMetadataLengthLimit],"URL",Restricted["Expression", {Hyperlink}]}


validatesourcemetadata["Contributor",expr_]:=interpretAlternatives["Contributor",$sourceinterpretertypes, expr]
validatesourcemetadata["Coverage",expr_]:=Interpreter[Restricted["String","*",$ShortMetadataLengthLimit]][expr]
