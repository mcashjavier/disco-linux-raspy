...
$textSearchIndexKeys:={"Name","Keywords","Categories","ContentTypes","Description"};
...
updatelocalResourceSearchIndex[sio_SearchIndexObject]:=With[{res=Quiet[UpdateSearchIndex[sio]]},
	If[res===$Failed,
		buildLocalResourceSearchIndex[]
		,
		sio]
...
addToLocalSearchIndex[id_, info_, dir_]:=With[{indexfile=createtextSearchIndexFile[id,info, dir]},
	If[TrueQ[Quiet[FileExistsQ[indexfile]]],
